...
var kamaDatepicker = function (elementID, opt) {
    ...
    if (options.swapNextPrev)
        titleDiv.append("<button id='bd-prev-" + elementID + "' class='bd-prev' type='button' title='ماه قبلی' data-toggle='tooltip'><span><i class=\"fa fa-reply\" aria-hidden=\"true\"></i></span></button>");
    else
        titleDiv.append("<button id='bd-next-" + elementID + "' class='bd-next' type='button' title='ماه بعدی' data-toggle='tooltip'><span><i class=\"fa fa-share\" aria-hidden=\"true\"></i></span></button>");
