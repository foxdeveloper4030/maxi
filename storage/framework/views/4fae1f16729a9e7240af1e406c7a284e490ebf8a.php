...
<div class="wrapper default shopping-page">
                ...
                <div class="col-12 text-center pt-2">
                    <div class="header-shopping-logo default">
                        <a href="<?php echo e(route('urlMain')); ?>">
                            <img src="https://khanehmobile.com/img/%D8%AE%D8%A7%D9%86%D9%87-%D9%85%D9%88%D8%A8%D8%A7%DB%8C%D9%84-logo-1548169420.jpg"
                                 alt="">
                        </a>
                    </div>
                </div>
                    ...
                    <section class="page-content default">
                                ...
                                <div class="checkout-contact-content">
                                    <ul class="checkout-contact-items">
                                        <li class="checkout-contact-item">
                                            گیرنده:
                                            <span class="full-name"><?php echo e(\App\Order::query()->find(session('order'))->name); ?>

                                                &ensp; <?php echo e(\App\Order::query()->find(session('order'))->lastname); ?>
                                        ...
                                        <li class="checkout-contact-item">
                                            <div class="checkout-contact-item checkout-contact-item-mobile">
                                                شماره تماس:
                                                <span class="mobile-phone"><?php echo e(\App\Order::query()->find(session('order'))->tel); ?></span>
                                            </div>
                                            <div class="checkout-contact-item-message">
                                                کد پستی:
                                                <span class="post-code"><?php echo e(\App\Order::query()->find(session('order'))->postal_code); ?></span>
                                            </div>
                                            <br>
                                            استان
                                            <span class="state"><?php echo e(\App\City::query()->find(\App\Order::query()->find(session('order'))->city_id)->province->name); ?>،</span>
                                            ‌شهر
                                            <span class="city"><?php echo e(\App\City::query()->find(\App\Order::query()->find(session('order'))->city_id)->name); ?></span>
                                            <br>
                                            آدرس:
                                            <span class="city"><?php echo e(\App\Order::query()->find(session('order'))->addres); ?></span>
                                        </li>
                                    </ul>
                        ...
                        <form method="post" id="shipping-data-form">
                            ...
                            <div class="checkout-shipment">
                                <?php $__currentLoopData = \App\Cariar::query()->where('active','=',1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cariar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                    <input type="radio" name="radio1" id="radio1" onclick="load('<?php echo e($cariar->id); ?>')"
                                           value="<?php echo e($cariar->id); ?>">
                                    <label for="radio1">
                                        <?php echo e($cariar->name); ?>
                            ...
                            <div class="checkout-pack">
                                <section class="products-compact">
                                    <div class="box">
                                        <div class="row">
                                            <?php $__currentLoopData = \App\Order::query()->find(session('order'))->carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                                    <div class="product-box-container">
                                                        <div class="product-box product-box-compact">
                                                            <a class="product-box-img">
                                                                <img src="<?php echo e((new App\PublicModel())->image_cover(App\Product::query()->find($cart["product_id"]))); ?>">
                                                            </a>
                        ...
                        <div class="checkout-summary">
                            <div class="checkout-summary-main">
                                <ul class="checkout-summary-summary">
                                    <li><span>مبلغ کل (<?php echo e(count(\App\Order::query()->find(session('order'))->carts)); ?> کالا)</span><span><?php echo e(number_format(\App\Order::query()->find(session('order'))->price)); ?> تومان</span>
                                    </li>
                                    <li>
                                ...
                                <div class="checkout-summary-content">
                                    ...
                                    <div class="checkout-summary-price-value">
                                        <span class="checkout-summary-price-value-amount"
                                              id="pricep"><?php echo e(number_format(\App\Order::query()->find(session('order'))->price)); ?></span>تومان
                                    </div>
                                    <a href="<?php echo e(route('main.order.payment')); ?>" class="selenium-next-step-shipping">
                                        <div class="parent-btn">
                                            <button id="buttonp" style="display: none" class="dk-btn dk-btn-info">
                                                ادامه ثبت سفارش
    ...
    <!-- main-shopping -->
    <?php echo $__env->make('sub.myfooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
</body>
<!--   Core JS Files   -->
...
<script>
    function load(id) {
        $(document).ready(function () {
            ...
            $.get("<?php echo e(route('order.add')); ?>/" + id, function (data, status) {
...
<?php /**PATH C:\xampp\htdocs\khanehkalaWithMelat\resources\views/front/step1.blade.php ENDPATH**/ ?>