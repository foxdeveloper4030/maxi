                ...
                <div class="col-12 text-center pt-2">
                    <div class="header-shopping-logo default">
                        <a href="<?php echo e(route('urlMain')); ?>" class="logo">
                            <img width="100" src="<?php echo e(asset('public/assets/img/logo.jpg')); ?>" alt="">
                        </a>
                    </div>
                </div>
...
<?php /**PATH /home2/maximors/public_html/resources/views/front/shopping_no_buy.blade.php ENDPATH**/ ?>