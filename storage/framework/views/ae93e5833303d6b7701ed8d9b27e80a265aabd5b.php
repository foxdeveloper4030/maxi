            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-5">
                <div class="logo-area default">
                    <a href="<?php echo e(route('urlMain')); ?>">
                        <img   src="<?php echo e(asset('public/assets/img/logo.jpg')); ?>" alt=" فروشگاه آنلاین ماکزی مورس">
                ...
                <?php $__currentLoopData = \App\Category::query()->orWhere('home','=',1)->where('parent_id','=',0)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php else: ?>
                        <li class="list-item list-item-has-children mega-menu mega-menu-col-5 " >
                            <a class="nav-link"
                               href="<?php echo e(route('category.show',['name'=>(new \App\PublicModel())->slug_format($category->name)])); ?>"><?php echo e($category->name); ?>&ensp;<i class="fa fa-mobile"></i></a>
...
<?php /**PATH /home2/maximors/public_html/maximorse/resources/views/sub/myheader.blade.php ENDPATH**/ ?>