...
<?php if(!empty($category->childs)): ?>
  ...
  <li><a href="<?php echo e(route('admincategory.show',['id'=>$category])); ?>"><i class="fa fa-circle-o"></i>افزودن زیر دسته</a>
                </li>
    </ul>
<?php endif; ?>

<?php /**PATH /home2/maximors/public_html/resources/views/admin/layouts/categorychilds.blade.php ENDPATH**/ ?>