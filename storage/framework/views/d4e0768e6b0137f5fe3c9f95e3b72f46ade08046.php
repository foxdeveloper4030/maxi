            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?php echo e(count(\App\Role::all())); ?></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?php echo e(count(\App\Permission::all())); ?></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" method="post"
                                  id="formSaveRolePermission" data-url="<?php echo e(route('admin.roles.permission.store')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="permission" multiple
                                            ...
                                            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($permission->id); ?>"><?php echo e($permission->permission); ?> / <?php echo e($permission->label); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/admin/role/create.blade.php ENDPATH**/ ?>