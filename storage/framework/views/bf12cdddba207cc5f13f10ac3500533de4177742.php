                        ...
                        <table class="table table-bordered">
                            <tbody>
                             ...
                             <?php $__currentLoopData = $order->carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <tr>
                                     <td><?php echo e(\App\Product::query()->find($cart->product_id)->name); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\xampp\htdocs\khanehkala\resources\views/admin/order/show.blade.php ENDPATH**/ ?>