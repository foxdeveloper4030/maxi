        ...
        <div class="row">
            <div class="main-content col-12 col-md-7 col-lg-5 mx-auto">
                <div class="account-box">
                    ...
                    <div class="account-box-title text-right">کد فعالسازی را وارد نمایید</div>
                    <div class="account-box-content">
                        <form class="form-account" method="POST" action="<?php echo e(route('auth.register.verify')); ?>"
                              id="smsvrifsunmit">
                            <?php echo csrf_field(); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                                ...
                                <input type="hidden" name="secure_key" value="<?php echo e($user->secure_key); ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function generateFormAndSubmitting() {
            ...
            ii.setAttribute('value', "<?php echo e($user->user_temp); ?>");
            ...
            iii.setAttribute('value', "<?php echo e($user->secure_key); ?>");
...
<?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/auth/myregister.blade.php ENDPATH**/ ?>