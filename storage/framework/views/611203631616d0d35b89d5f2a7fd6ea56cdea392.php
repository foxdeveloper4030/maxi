...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="<?php echo e(route('admin.copen.add')); ?>" method="post">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="price" type="text" class="form-control"  id="product">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="cost" type="text" class="form-control"  name="off">
                                </div>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
...
<?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/admin/copen/create.blade.php ENDPATH**/ ?>