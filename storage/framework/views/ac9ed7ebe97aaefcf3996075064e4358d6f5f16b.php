                            ...
                            <form name="meForm" class="form-account" method="post" action="<?php echo e(url('')); ?>/order/register">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="form-account-row">
                                            <input name="phone_mobile" id="phone_mobile" class="input-field" type="text" >
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-account-title">کد پستی</div>
                                        <div class="form-account-row">
                                            <input name="postcode" id="postcode" class="input-field" type="text" >
                                        </div>
                                    </div>
                                    <div class="col-12">
...
<?php /**PATH C:\xampp\htdocs\max\resources\views/front/orderregister.blade.php ENDPATH**/ ?>