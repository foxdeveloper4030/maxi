<?php $__env->startSection('title'); ?>
    بروزرسانی نقش <?php echo e($role->role); ?> | پنل ادمین
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">بروزرسانی نقش <?php echo e($role->role); ?></span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">تعداد مسئولیت‌های این نقش</span>
                        <span class="info-box-number"><?php echo e(count($role->permissions)); ?></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-10">
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">بروزرسانی نقش <?php echo e($role->role); ?></h3>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="permission" multiple
                                            ...
                                            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($permission->id); ?>"><?php echo e($permission->permission); ?>
                                        ...
                                        <?php $__currentLoopData = $role->permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <script type="text/javascript">
                                                permissionIdSelected[idx] = "<?php echo e($p->id); ?>";
                                                idx++;
                                            </script>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        $('#permission').val(permissionIdSelected);
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/admin/role/update.blade.php ENDPATH**/ ?>