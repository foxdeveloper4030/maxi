<?php $__env->startSection('title'); ?>
    بروزرسانی نقش کاربر<?php echo e($user->fullName); ?> | پنل ادمین
<?php $__env->stopSection(); ?>

<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" href="<?php echo asset('public/admin/plugins/select2.min.css'); ?>">
    <style>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">بروزرسانی نقش <?php echo e($user->role); ?></span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">تعداد نقش‌های کاربر <?php echo e($user->fullName); ?></span>
                        <span class="info-box-number"><?php echo e($user->roles()->count()); ?></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-10">
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">بروزرسانی نقش کاربر <?php echo e($user->fullName); ?></h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" method="post"
                                  id="formSaveRolePermission"
                                  data-url="<?php echo e(route('admin.user.roles.update',$user->id)); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="role" style="width: 100%!important;height: 100%!important;"
                                                class="col-md-10 form-control search-field" dir="rtl" title="نقش کاربر"
                                                name="role">
                                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($role->id); ?>"><?php echo e($role->role); ?>
                                        ...
                                        <script type="text/javascript">
                                            roleIdSelected[idx] = "<?php echo e($user->roles()->first()->id); ?>";
                                            idx++;
                                        </script>
                                    </div>
                                </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript" src="<?php echo asset('public/admin/plugins/select2.full.min.js'); ?>"></script>
    <script>
        $('#role').select2({
            ...
            allowClear: true,
            placeholder: 'نقشی را انتخاب نمایید...',
            language: {
                "searching": function () {
                    return "در حال جستجو ...";
                },
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data['status']) {
                            ...
                            roleIdSelected = [];
                            idx = 0;
                            roleIdSelected[idx] = data['roleId'];
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/admin/userManage/update.blade.php ENDPATH**/ ?>