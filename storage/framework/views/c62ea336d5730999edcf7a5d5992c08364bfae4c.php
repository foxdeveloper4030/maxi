...
<head>
    ...
    <title>ورود || <?php echo e(\App\PublicModel::EnappName()); ?></title>
        ...
        <div class="row">
            <div class="main-content col-12 col-md-11 col-lg-9 mx-auto">
                ...
                <div class="account-box1 col-12 col-md-10 col-lg-8 mx-auto">
                    <div class="account-box-title" style="text-align: center">ورود به <?php echo e(\App\PublicModel::EnappName()); ?></div>
                            ...
                            <div class="form-account-row form-account-submit">
                                <div class="parent-btn">
                                    <button class="dk-btn dk-btn-info" type="submit">
                                        ورود به <?php echo e(\App\PublicModel::EnappName()); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="account-box-footer">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn-link-border">ثبت‌نام در
                            <?php echo e(\App\PublicModel::EnappName()); ?></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="mini-footer">
        <nav>
            <div class="container">
                <ul class="menu">
                    <li>
                        <a href="#">درباره <?php echo e(\App\PublicModel::EnappName()); ?></a>
                    </li>
                    <li>
...
<?php /**PATH C:\xampp\htdocs\khanehkala\resources\views/auth/login.blade.php ENDPATH**/ ?>