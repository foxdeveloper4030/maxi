            ...
            <section id="main-slider" class="carousel slide carousel-fade card" data-ride="carousel">
                <ol class="carousel-indicators">
                    ...
                    <?php $__currentLoopData = \App\Slider::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li data-target="#main-slider" data-slide-to="<?php echo e($slidindex); ?>" <?php if($slidindex==0): ?> class="active" <?php endif; ?>></li>
                ...
                <div class="carousel-inner">
                    <?php  $slidindex=0 ?>
                    <?php $__currentLoopData = \App\Slider::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="carousel-item <?php if($slidindex==0): ?> active <?php endif; ?>">
...
// If the count down is over, write some text
            ...
            <?php $__currentLoopData = \App\HomeCategory::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="row">
                    <div class="col-12">
                        <div class="widget widget-product card">
                            <header class="card-header">
                                ...
                                <a href="<?php echo e(route('category.show',['name'=>(new \App\PublicModel())->slug_format($item->category->name)])); ?>" class="view-all">مشاهده همه</a>
                            </header>
                            <div class="product-carousel owl-carousel owl-theme">
                                <?php $__currentLoopData = \App\Product::query()->orWhere('price_main','>',1000)->where('category_id','=',$item->category_id)->orderByDesc('id')->limit(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="item">
                                    <a href="<?php echo e(route('main.product.show',['slug'=>$product->slug])); ?>">
                                        <img src="<?php echo e((new \App\PublicModel())->image_cover($product,1)); ?>"
                                             class="img-fluid" alt="">
                                    </a>
                                    <h2 class="post-title">
                                    ...
                                    <?php if(! $isExhibition): ?>
                                        <div class="price">
                                            ...
                                            <?php else: ?>
                                                <div class="text-center">
                                                    <ins>
                                                        <span><?php echo e(number_format($product->price_main)); ?><span>تومان</span></span>
                                                    </ins>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    <?php else: ?>
                                        <div class="price">
                                            <div class="text-center" style="font-size: 10px">
                                                برای استعلام قیمت، با واحد پشتیبانی تماس حاصل نمایید.
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    <div class="btn-group">
...
<style>
                                       ...
                                       <?php if(empty((new \App\Model\ProductModel($product->id))->getdefaultattribute())): ?>
                                        <button onmouseenter="ok(this)"
                                        <?php if($isExhibition): ?> disabled style="background-color: #e3e300; border-color: yellow" <?php endif; ?>
                                        id="fastmode-cart" onclick="maincart('<?php echo e($product->id); ?>','0')" type="button" class="myButton"> <i class="fa fa-shopping-cart"></i></button>
                                      <?php else: ?>
                                            <button data-toggle="444"
                                            <?php if($isExhibition): ?> disabled style="background-color: #e3e300; border-color: yellow" <?php endif; ?>
                                            onmouseenter="ok(this)" id="fastmode-cart"  onclick="maincart('<?php echo e($product->id); ?>','<?php echo e((new \App\Model\ProductModel($product->id))->getdefaultattribute()->id); ?>')" type="button" class="myButton"><i class="fa fa-shopping-cart"></i></button>
                                       <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/front/main.blade.php ENDPATH**/ ?>