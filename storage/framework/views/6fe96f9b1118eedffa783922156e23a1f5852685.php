                   ...
                   <?php if($category->parent_id!=0): ?>
                    ...
                    <div class="pager default text-center">
                       ...
                       <?php else: ?>
                            ...
                            <?php if(0<count(\App\Product::query()->orWhere('price_main','>',1000)->where('category_id','=',$cat->id)->orderByDesc('id')->limit(10)->get())): ?>
                                  <div class="widget widget-product card">
                                <header class="card-header">
                                    <h3 class="card-title">
                                    ...
                                    <a href="<?php echo e(route('category.show',['name'=>(new \App\PublicModel())->slug_format($cat->name)])); ?>"
                                       class="view-all">مشاهده همه</a>

                                </header>
                                <div class="product-carousel owl-carousel owl-theme">

                                    <?php $__currentLoopData = \App\Product::query()->orWhere('price_main','>',1000)->where('category_id','=',$cat->id)->orderByDesc('id')->limit(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/maximors/public_html/maximorse/resources/views/front/category_show.blade.php ENDPATH**/ ?>