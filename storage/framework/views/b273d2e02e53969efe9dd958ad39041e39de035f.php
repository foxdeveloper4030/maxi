...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> ||  {{\App\PublicModel::EnappName()}}</title>
                        ...
                        <div class="product-variants col col-lg-8 justify-content-around">
                            ...
                            <div class="" style="width: 100%;margin: 2% 25% 0 2px;">
                                ...
                                <div class="radio mr-5">
                                    <input type="radio" name="sendAddress" id="otherAddr" value="otherAddr">
                                    <label for="otherAddr">ارسال به آدرس دیگر</label>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/front/orderregister.blade.php ENDPATH**/ ?>
