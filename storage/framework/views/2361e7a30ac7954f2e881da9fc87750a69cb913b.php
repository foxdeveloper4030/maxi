                                ...
                                <div id="gallery_01f" style="width:500px;float:left;">
                                    <ul class="gallery-items owl-carousel owl-theme" id="gallery-slider">
                                        ...
                                        <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="item">
                                                <a href="#" onclick="document.getElementById('img-product-zoom').src='<?php echo e((new App\PublicModel())->image_show($image)); ?>'" class="elevatezoom-gallery active" data-update=""
                                        ...
                                        <article>
                                            ...
                                            <section>
                                                ...
                                                <ul class="params-list">
                                                    <?php $__currentLoopData = $category->feature_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                        <hr>
                                                        <div class="badge badge-success"><?php echo e($feature_cat->name); ?></div>


                                                        <li>
                                                            <?php $__currentLoopData = $feature_cat->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                                <?php if(App\PublicModel::feature_value($product->id,$feature->id)!=" "): ?>
                                                                    <div class="params-list-key">
                                                                        <span class="inline"><i class="fa fa-check-square"></i> <?php echo e($feature->feature); ?>:</span>
                                                                        <?php echo e(App\PublicModel::feature_value($product->id,$feature->id)); ?>
                ...
                <div class="product-carousel owl-carousel owl-theme">
                    ...
                    <?php $__currentLoopData = \App\Product::query()->orWhere('price_main','>',1000)->where('category_id','=',$category->id)->orderByDesc('id')->limit(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item" style="max-width: 300px;">
                            ...
                            <?php echo $__env->make('product.price', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/maximors/public_html/maximorse/resources/views/product/show_product_main.blade.php ENDPATH**/ ?>