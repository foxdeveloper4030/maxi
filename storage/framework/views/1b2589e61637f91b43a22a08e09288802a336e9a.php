            ...
            <div class="main-content col-12 col-md-7 col-lg-5 mx-auto">
                <div class="account-box">
                    ...
                    <div class="account-box-content">
                        <form class="form-account" method="post" action="<?php echo e(route('pass3.changePassedForgetPass')); ?>">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="secure_key" value="<?php echo e($secure_key); ?>">
                            ...
                            <?php if($errors->has('mobile')): ?>
                                <span class="invalid-feedback" role="alert">
                                    <strong style="color: darkred;"><?php echo e($errors->first('password')); ?></strong>
                                </span>
                            <?php endif; ?>
                            ...
                            <div class="form-account-row">
                                ...
                                <?php if($errors->has('password_confirmation')): ?>
                                    <span class="invalid-feedback" role="alert">
                                        <strong style="color: darkred;"><?php echo e($errors->first('password_confirmation')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
...
<?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/auth/passwords/step2Reset.blade.php ENDPATH**/ ?>