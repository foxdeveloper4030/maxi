...
<?php $__env->startSection('content'); ?>
    <!-- main -->
    <main class="search-page amazing-search default" style="background:'<?php echo e(url('public/img')); ?>/search_back.png' ">
        <div class="container">
            <div class="row">
                <div class="col-12">
                ...
                <div class="amazing-content col-12 col-sm-12 col-md-8 col-lg-9 order-2">
                    <div class="breadcrumb-section default">
                        <ul class="breadcrumb-list">
                            <li>
                                <a href="#">
                                    <span>فروشگاه اینترنتی خانه موبایل</span>
                                </a>
                            </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\khanehkala\resources\views/front/search.blade.php ENDPATH**/ ?>