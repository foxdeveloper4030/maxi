                                                    ...
                                                    <ul class="params-list">
                                                        <?php $__currentLoopData = $category->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                           <?php if(\App\PublicModel::feature_value($product->id,$feature->id)!=" "): ?>
                                                               <?php if($sub!=$feature->sub->name): ?>
                                                                   <?php
                                                                    $sub=$feature->sub->name;
                                                                    ?>
                                                                       <hr>
                                                                   <div class="badge badge-success"><?php echo e($sub); ?></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rel\resources\views/product/show_product_main.blade.php ENDPATH**/ ?>