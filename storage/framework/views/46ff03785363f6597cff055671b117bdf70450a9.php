...
<head>
    ...
    <title>افزودن حامل | کنترل پنل</title>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body pad">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="<?php echo e(route('admin.cariar.store')); ?>" method="post"  enctype="multipart/form-data">
                                <div class="box-body">
                                    <input name="citys" type="hidden">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">عنوان حامل</label>
                                        <input required="required" name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="عنوان">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="input-group"00 >
                                        ...
                                        <div class="input-group clockpicker" data-placement="top" data-align="left" data-donetext="تایید" >
                                            ...
                                            <input required="required" type="text" class="form-control" id="stop" name="time_start" >
                                    ...
                                    <div class="input-group" >
                                        ...
                                        <div class="input-group clockpicker" data-placement="top" data-align="left" data-donetext="تایید" >
                                            ...
                                            <input required="required" type="text" class="form-control" id="stop" name="time_end" >
                                            <span class="input-group-addon">
				                                    <span class="fa fa-time"></span>
			                                </span>
                                    ...
                                    <div class="input-group" >
                                        ...
                                        <div class="input-group clockpicker" data-placement="top" data-align="left" data-donetext="تایید" >
                                            ...
                                            <input required="required" type="text" class="form-control" id="stop" name="price" >
                                            <span class="input-group-addon">
				                                    <span class="fa fa-time"></span>
			                                </span>
                                    ...
                                    <div class="input-group" >
                                        ...
                                        <div class="input-group clockpicker" data-placement="top" data-align="left" data-donetext="تایید" >
                                            ...
                                            <input required="required" type="text" class="form-control" id="stop" name="off" >
                                            <span class="input-group-addon">
				                                    <span class="fa fa-time"></span>
			                                </span>
                                    ...
                                    <div class="input-group" >
                                        ...
                                        <div class="input-group clockpicker" data-placement="top" data-align="left" data-donetext="تایید" >
                                            ...
                                            <input required="required" type="text" class="form-control" id="stop" name="time_hi" >
                                            <span class="input-group-addon">
				                                    <span class="fa fa-time"></span>
			                                </span>
                                    ...
                                    <div class="input-group" >
                                        ...
                                        <div class="input-group clockpicker" data-placement="top" data-align="left" data-donetext="تایید" >
                                            ...
                                            <input required="required" type="text" class="form-control" id="stop" name="time_low" >
                                            <span class="input-group-addon">
				                                    <span class="fa fa-time"></span>
			                                </span>
                                    ...
                                    <div class="col-md-12">
                                      <?php $__currentLoopData = \App\Province::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          ...
                                          <input name="city<?php echo e($province->id); ?>" type="checkbox">
                                          </span>
...
</html><?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/admin/cariar/cariar_create.blade.php ENDPATH**/ ?>