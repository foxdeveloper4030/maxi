...
<head>
    ...
    <title>کپن <?php echo e($copen->code); ?>| کنترل پنل</title>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="<?php echo e(route('admin.copen.update',['id'=>$copen->id])); ?>" method="post">

          <?php echo csrf_field(); ?>
        <!-- Main content -->
        <section class="content">
            <h2>افزودن تاریح پایان کپن</h2>
            <!-- SELECT2 EXAMPLE -->
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input value="<?php echo e($copen->code); ?>" id="observer" name="time" />
                                    <br>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body no-padding">
                            ...
                            <tr>
                                        ...
                                        <?php if($now<$time): ?>
                                            <td><span class="badge bg-green">فعال</span>
                                            </td>
                                        <?php else: ?>
                                        ...
                                        <td>
                                            <a class="btn-danger btn" href="<?php echo e(route('admin.copen.delete',['id'=>$copen->id])); ?>">
                                                حذف
                                            </a>
                                        </td>
                                    </tr>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-danger">
                        <div class="box-header">
                            <h3 class="box-title">ویرایش کپن</h3>
                        </div>
                        <div class="box-body">
                            <!-- Date dd/mm/yyyy -->
                            <div class="form-group">
                                <label>حداقل قیمت برای اختصاص یافتن کپن</label>

                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                    </div>
                                    <input value="<?php echo e($copen->price); ?>" name="price" type="text" class="form-control"  id="product">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?php echo e($copen->off); ?>" id="cost" type="text" class="form-control"  name="off">
                                </div>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?php echo e($copen->code); ?>" type="text" class="form-control" name="code">
                                </div>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
...
<script>
    ...
    function ajax_name(name) {
        ...
        $(document).ready(function(){
            //document.getElementById('loading').style.display='block';
            $.get("<?php echo e(url('')); ?>/admin/specialproduct/ajax/name/"+name, function(data, status){
...
<?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/admin/copen/edite.blade.php ENDPATH**/ ?>