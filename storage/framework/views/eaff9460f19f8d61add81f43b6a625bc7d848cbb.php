                        ...
                        <table class="table table-hover">
                            ...
                            <?php $__currentLoopData = $users1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td style="text-align:center"><?php echo e($user->firstname); ?>.<?php echo e($user->lastname); ?></td>
                                    <td style="text-align:center"><?php echo e((new \App\Model\Date())->jdate('j/F/Y',$user->last_seen,$tr_nam='en')); ?></td>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\khanehkala\resources\views/admin/users/search.blade.php ENDPATH**/ ?>