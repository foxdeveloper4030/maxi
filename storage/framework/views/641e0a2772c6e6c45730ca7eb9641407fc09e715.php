<?php $__env->startSection('title'); ?>
    افزودن نقش به کاربران | پنل ادمین
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">افزودن نقش به کاربران</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">تعداد کاربران نقش گرفته</span>
                        <span
                            class="info-box-number"><?php echo e(\Illuminate\Support\Facades\DB::table('role_user')->count()); ?></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
                ...
                <div class="col-md-10">
                    <div class="box">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">افزودن نقش به کاربران</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="box box-primary">
                                ...
                                <form role="form" method="post"
                                      id="formSaveRolePermission" data-url="<?php echo e(route('admin.user.roles.store')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="user">کاربران</label>
                                            <select id="user" title="نقش‌ها" name="user"
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        $('#user').select2({
            ...
            placeholder: 'کاربر مورد نظر خود را انتخاب نمایید...',
            language: {
                searching: function () {
                    return "در حال جستجو ...";
                },
                "noResults": function () {
                    return "کاربری با این اسم، پیدا نشد...";
                }
            },
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/admin/userManage/create.blade.php ENDPATH**/ ?>