                            ...
                            <div class="content-section default">
                                <div class="row">
                                    ...
                                    <span style="width: 100%; text-align: center; font-size: 12px">
                                        <a href="<?php echo e(route('main.user.love')); ?>" style="color: #00bfd6;">لیست علاقه مندی ها</a>
                                    </span>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/auth/panel.blade.php ENDPATH**/ ?>