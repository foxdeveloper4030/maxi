                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <?php $__currentLoopData = $warranties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warranty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td><span class="label label-info"><?php echo e($warranty->name); ?></span></td>

                                    <td>
                                        <form action="<?php echo e(route('admin.warranty.edit',['id'=>$warranty->id])); ?>" method="post">
                                            <?php echo csrf_field(); ?>
                                            <input type="text" value="<?php echo e($warranty->name); ?>" name="name">&ensp;<input type="submit" class="btn btn-success btn-sm" value="ویرایش">
                                        </form>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?php echo e(route('admin.warranty.add')); ?>">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/maximors/public_html/resources/views/admin/warranty/allwarranties.blade.php ENDPATH**/ ?>