                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body pad">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="<?php echo e(route('admin.slider.store')); ?>" method="post" enctype="multipart/form-data">
                                <div class="box-body">
...
</html><?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/admin/design/slider_create.blade.php ENDPATH**/ ?>