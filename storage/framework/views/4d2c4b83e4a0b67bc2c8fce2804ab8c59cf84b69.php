                        ...
                        <table class="table table-bordered">
                            ...
                            <?php $__currentLoopData = $product->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($feature->feature->name); ?></td>
                                            <td><?php echo e($feature->value->value); ?></td>
                                            <td>
                                                <a href="<?php echo e(route('admin.product.feature.delete',['id'=>$feature->id])); ?>" class="btn btn-danger" >حذف</a>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\max\resources\views/admin/product/show.blade.php ENDPATH**/ ?>