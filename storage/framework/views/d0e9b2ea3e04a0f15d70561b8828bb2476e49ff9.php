...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="<?php echo e(route('special.store')); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="box-body table-responsive no-padding" style="overflow: scroll;height: 200px">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <?php $__currentLoopData = \App\Product::query()->where('price_main','>',1000)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
...
</html><?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/admin/product/special_create.blade.php ENDPATH**/ ?>