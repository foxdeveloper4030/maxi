                        ...
                        <table class="table table-condensed">
                            ...
                            <?php $__currentLoopData = \App\Special::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $special): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <?php endif; ?>
                                    <td>
                                        <a href="<?php echo e(route('special.show',['id'=>$special->id])); ?>"
                                           class="btn-primary btn">نمایش</a>
                                    </td>
                                    <td>
                                        <a class="btn-danger btn" href="<?php echo e(route('special.destroy',['id'=>$special->id])); ?>">
                                            حذف
                                        </a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\khanehkal\resources\views/admin/product/specials.blade.php ENDPATH**/ ?>