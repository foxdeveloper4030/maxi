                    ...
                    <div class="box-body">
                        ...
                        <div class="box box-primary">
                            ...
                            <form  enctype="multipart/form-data" method="post"
                                   action="<?php echo e(route('admin.brand.store')); ?>">
                                ...
                                <div class="box-body">
                                   ...
                                   <input type="submit" class="btn btn-danger" value="افزودن">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/maximors/public_html/resources/views/admin/brand/create.blade.php ENDPATH**/ ?>