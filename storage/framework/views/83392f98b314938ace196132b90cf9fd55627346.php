            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span
                            class="label label-success"><?php echo e(count(\Illuminate\Support\Facades\DB::select('SELECT * FROM `usermessages` WHERE `read`=0'))); ?></span>
                    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <span style="display: block"><small><?php echo e((new \App\Model\Date())->jdate('j/F/Y، ساعت H:i:s',$user4030->last_seen)); ?></small></span>
                            <br>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class=" treeview">
                ...
                <ul class="treeview-menu">
                    <li class=""><a href="<?php echo e(route('admin.order.index')); ?>"><i class="fa fa-list"></i> سفارش ها</a>
                    </li>
                    <li class=""><a href="<?php echo e(route('admin.order.indexUnfinish')); ?>"><i class="fa fa-shopping-cart"></i>سبدهای
                            خرید ناتمام</a>
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo e(route('admin.roles.permission.create')); ?>"><i class="fa fa-plus-circle"></i>افزودن مسئولیت به نقش‌ها</a>
                    </li>
                    <li><a href="<?php echo e(route('LevelManages.index')); ?>"><i class="fa fa-user-circle"></i>کاربران</a>
                    </li>
                    <li><a href="<?php echo e(route('admin.user.roles.create')); ?>"><i class="fa fa-user-plus"></i>افزودن نقش به کاربران</a>
                    </li>
                </ul>
            </li>
            <?php endif; ?>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo e(route('special.create')); ?>"><i class="fa fa-circle-o"></i> افزودن پیشنهاد شگفت انگیز</a></li>
                    <li><a href="<?php echo e(route('admin.copen.create')); ?>"><i class="fa fa-circle-o"></i> افزودن کپن تخفیف</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo e(route('admin.brand.index')); ?>"><i class="fa fa-circle-o"></i>لیست برندها</a></li>
                    <li><a href="<?php echo e(route('admin.brand.create')); ?>"><i class="fa fa-plus-circle"></i>ایجاد برند</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="">
...
</script><?php /**PATH /home/dotjpg/public_html/sup/khanehkala/resources/views/admin/layouts/header.blade.php ENDPATH**/ ?>