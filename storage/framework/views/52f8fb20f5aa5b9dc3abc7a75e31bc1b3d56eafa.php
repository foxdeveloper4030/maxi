...
<div class="wrapper default shopping-page">
    ...
    <main class="cart-page default">
        <div class="container">
            <form class="row" method="post" id="shipping-data-form" action="<?php echo e(route('main.order.payment')); ?>">
                <?php echo csrf_field(); ?>
                    ...
                    <section class="page-content default">
                                    ...
                                    <ul class="checkout-contact-items">
                                        ...
                                        <li class="checkout-contact-item">
                                            <div class="checkout-contact-item checkout-contact-item-mobile">
                                                شماره تماس:
                                                <span
                                                    class="mobile-phone"><?php echo e(\App\Order::query()->find(session('order'))->tel); ?></span>
                                            </div>
                                            <div class="checkout-contact-item-message">
                                                کد پستی:
                                                <span
                                                    class="post-code"><?php echo e(\App\Order::query()->find(session('order'))->postal_code); ?></span>
                                            </div>
                                            <br>
                                            استان
                                            ...
                                            ‌شهر
                                            <span
                                                class="city"><?php echo e(\App\City::query()->find(\App\Order::query()->find(session('order'))->city_id)->name); ?></span>
                                            <br>
                                            آدرس:
                                            <span
                                                class="city"><?php echo e(\App\Order::query()->find(session('order'))->addres); ?></span>
                                        </li>
                                    </ul>
                        ...
                        <div class="checkout-shipment posts">
                            <?php $__currentLoopData = \App\Cariar::query()->where('active','=',1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cariar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="radiobtn">
                                    <input type="radio" id="radio<?php echo e($cariar->id); ?>"
                                           name="carrierId" onclick="load('<?php echo e($cariar->id); ?>')"
                                           value="<?php echo e($cariar->id); ?>"/>
                                    <label for="radio<?php echo e($cariar->id); ?>"><?php echo e($cariar->name); ?></label>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <input type="hidden" name="orderId" value="<?php echo e(session('order')); ?>">
                        <div class="headline">
                                        ...
                                        <span class="wiki wiki-holder"><span class="wiki-sign"></span>
                                                <div class="wiki-container is-right">
                                                    ...
                                                    <p class="wiki-text">
                                                        ...
                                                        برای شما رزرو
                                                        می‌شوند. در
                                                        صورت عدم ثبت سفارش،  <?php echo e(\App\PublicModel::EnappName()); ?> هیچگونه مسئولیتی در قبال تغییر
                                                        قیمت یا موجودی
                                                        این کالاها
                                                        ندارد.
                                                    </p>
...
<?php /**PATH /home2/maximors/public_html/resources/views/front/step1.blade.php ENDPATH**/ ?>