...
class ForgotPasswordController extends Controller
{
    ...
    */
    ...
    public function smsVerifyingForgetPass1(Request $request)
    {
        ...
        if (User::query()->where('mobile','=',$request->mobile)->first()!=null)
        {
           $user=User::query()->where('mobile','=',$request->mobile)->first();
            ...
            $text='کاربر گرامی رمز عبور شما در maximorse.com :'.$pass;
            ...
            return view('auth.passwords.step0Reset',['message'=>'شماره موبایل یافت نشد. ']);
    }
