    ...
    <div class="container">
        <div class="navbar-translate">
            ...
            <div class="search-nav default">
                <form action="">
                    <input type="text" id="gsearchsimple1"  placeholder="جستجو ...">
                    <button type="button" onclick="window.location.href='{{url('')}}/search/'+document.getElementById('gsearchsimple1').value"><img src="{{asset('public/assets/img/search.png')}}" alt=""></button>
                </form>
                <ul>
