                   ...
                   @if($category->parent_id!=0)
                    ...
                    <div class="pager default text-center">
                       ...
                       @else
                            ...
                            @if(0<count(\App\Product::query()->orWhere('price_main','>',1000)->where('category_id','=',$cat->id)->orderByDesc('id')->limit(10)->get()))
                                  <div class="widget widget-product card">
                                <header class="card-header">
                                    <h3 class="card-title">
                                    ...
                                    <a href="{{route('category.show',['name'=>(new \App\PublicModel())->slug_format($cat->name)])}}"
                                       class="view-all">مشاهده همه</a>

                                </header>
                                <div class="product-carousel owl-carousel owl-theme">

                                    @foreach(\App\Product::query()->orWhere('price_main','>',1000)->where('category_id','=',$cat->id)->orderByDesc('id')->limit(10)->get() as $product)
