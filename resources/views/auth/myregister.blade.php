...
<head>
    ...
    <title>تایید  کاربری || {{\App\PublicModel::EnappName()}}</title>
    <!--     Fonts and icons     -->
                ...
                <div class="account-box">
                    ...
                    <div class="account-box-footer" style="padding: 1%">
                        ...
                        <div class="form-account-submit" style="margin: 0 -10px 1%">
                            ...
                            <a href="{{route('login')}}" class="col-md-3 btn mce-btn-small btn-info">
            ...
            <div class="container">
                <ul class="menu">
                    <li>
                        ...
                        <a href="{{url('')}}">درباره {{\App\PublicModel::EnappName()}}</a>
                    </li>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function generateFormAndSubmitting() {
            ...
            f.setAttribute('action', "{{route('auth.resend.verify.code')}}");
