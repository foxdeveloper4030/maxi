...
<head>
    ...
    <title>تغییر رمز عبور ||  {{\App\PublicModel::EnappName()}}</title>
    <!--     Fonts and icons     -->
        ...
        <div class="row">
            <div class="main-content col-12 col-md-11 col-lg-9 mx-auto">
                <a href="{{route('urlMain')}}" class="logo">
                    <img src="{{url('')}}/public/assets/img/logo.jpg" alt="logo"
                ...
                <div class="account-box1 col-12 col-md-10 col-lg-8 mx-auto">
                    ...
                    <div class="account-box-content">
                        <form class="form-account" method="post" action="{{route('main.user.changepass.save')}}">
                            @csrf
                            ...
                            <div class="form-account-row">
                                ...
                                <input name="oldpass" class="input-field @error('oldpass') is-invalid @enderror"
                                       type="password"
                            ...
                            <div class="form-account-row">
                                <label class="input-label" for="password"><i
                                            class="now-ui-icons ui-1_lock-circle-open"></i></label>
                                <input name="password" class="input-field @error('password') is-invalid @enderror"
                                       type="password"
    ...
    <footer class="mini-footer">
        <nav>
            <div class="container">
                <ul class="menu">
                    <li>
                        <a href="#">درباره  {{\App\PublicModel::EnappName()}}</a>
                    </li>
                    <li>
        ...
        <div class="copyright-bar">
            <div class="container">
                <p>
                    ...
                    به شرکت نوآوران فن آوازه (فروشگاه آنلاین  {{\App\PublicModel::EnappName()}}) می‌باشد.
                </p>
            </div>
        </div>
    </footer>
