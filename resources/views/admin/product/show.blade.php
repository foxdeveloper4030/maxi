            ...
            <div class="col-md-10">
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <a class="btn btn-primary" href="{{route('main.product.show',['slug'=>$product->slug])}}" target="_blank">مشاهده محصول درون سایت</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form role="form" enctype="multipart/form-data" method="post" action="{{route('products.update',['id'=>$product->id])}}">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input value="{{$product->name}}" name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="نام محصول">
                                </div>
                  ...
                  <textarea  id="editor1" name="details" rows="10"
                             cols="80">{{$product->details}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{$product->price_main}}" name="price_main" type="text" class="form-control" id="exampleInputEmail1" placeholder="قیمت محصول">
                                </div>
                               @if(count($product->colors)<1)
                                <div class="form-group">
                                    <label for="exampleInputEmail1">تعداد</label>
                                    <input value="{{$product->quantity}}" name="quantity" type="text" class="form-control" id="exampleInputEmail1" placeholder="قیمت محصول">
                                </div>
                                @endif
                                <div class="form-group">
                                    <label for="exampleInputEmail1">قیمت با مالیات (اختیاری)</label>
                                    <input value="{{$product->wholesale_price}}" name="wholesale_price" type="text" class="form-control" id="exampleInputEmail1" placeholder="قیمت با مالیات محصول">
                                </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($product->colors as $color)
                                <tr>
                                    ...
                                    <td>{{$color->count}}</td>
                                    <td>
                                        <button type="button" onclick="setColor('{{$color->id}}','{{$color->price}}','{{$color->count}}')" class="btn btn-info" data-toggle="modal" data-target="#modal-color">ویرایش</button>
                                    </td>
                                    <td>
                                        <a href="{{route('admin.product.color.delete',['id'=>$color->id])}}" class="btn btn-danger" >حذف</a>
                                    </td>
                                </tr>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($product->warranties as $w)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.product.warranty.delete',['id'=>$w->id])}}" class="btn btn-danger" >حذف</a>
                                    </td>
                                </tr>
                            ...
                            <tbody>
                              ...
                              @foreach($category->features as $feature)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button onclick="edite_feature('{{$product->id}}','{{$feature->id}}',document.getElementById('fid{{$feature->id}}').value)" class="btn btn-danger" >ویرایش</button>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($product->images as $image)
                                ...
                                <tr>
                                    ...
                                    @if($image->cover==0)
                                    <td>
                                     <a class="btn btn-danger" href="{{route('admin.product.image.delete',['id'=>$image->id])}}">حذف</a>
                                    </td>
                                        <td><a href="{{route('admin.product.image.set',['id'=>$image->id,'product'=>$product->id])}}" class="btn btn-info">کاور</a></td>
                                      @else
                                        <td>کاور</td>
                                        <td></td>
