        ...
        <div class="col-md-10">
            <div class="box">
                <div class="box-header with-border">
                        ...
                        <button class="btn btn-success" id="snk" onclick="Tost_show('{{$product->name}}')">نام محصول؟</button>
                ...
                <div class="box-body">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border" id="catss" style="height: 200px;overflow: scroll">
                            @include('admin.product.relationCats',['product'=>$product])
                        </div>
            ...
            <div id="attribute">
                @include('admin.product.ProductAttribute',['product'=>$product])
            </div>
            <br>
            <br>
            <div class="box">
    ...
    <script>
        function DeleteCat(product,cat) {
            ...
            $(document).ready(function () {
                ...
                $.get("{{url('')}}/admin/product/add/store/removecat/" +product+'/'+cat, function (data, status) {
                  //   alert(data);
        ...
        function AddCat(product,cat) {
            ...
            $(document).ready(function () {
                ...
                $.get("{{url('')}}/admin/product/add/store/addcat/" +product+'/'+cat, function (data, status) {
                  //   alert(data);
                    document.getElementById('catss').innerHTML=data;
        ...
        function chaneQ() {
            ...
            $(document).ready(function () {
                ...
                $.get("{{url('')}}/admin/product/add/store/changeq/" +product+'/'+q, function (data, status) {
                  //   alert(data);
        ...
        function addp() {
            let countgroup={{count(\App\Group::all())}};
            let countselect=0;
            ...
            element.push(document.getElementById("group"+"{{$group->id}}").value);
                @endforeach
            ...
            if (countselect==0&&price>=0&&quantity>=0&&weight>=0)
                ...
                $.get("{{url('')}}/admin/product/add/store/addAttribute/{{$product->id}}/["+element1.toString()+"]/"+quantity+"/"+price+"/"+weight, function (data, status) {
        ...
        function deleteConmbine(combine,attribute) {
            ...
            $.get("{{url('')}}/admin/product/add/store/removeAttribute/{{$product->id}}/"+combine+"/"+attribute, function (data, status) {
                //   alert(data);
                document.getElementById('attribute').innerHTML=data;
