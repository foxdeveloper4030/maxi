...
<head>
    ...
    <title> پنل مدیریت | {{\App\PublicModel::EnappName()}} </title>
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <a href="{{route('admin.order.index')}}" class="small-box-footer">اطلاعات بیشتر <i
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        <div class="inner">
                            <h3>{{request()->ip()}}<sup style="font-size: 20px"></sup></h3>
                    ...
                    <div class="small-box bg-red">
                        <div class="inner">
                            <h4><?php
                                ...
                                ?>{{number_format(round($priceweek)/$index)}}
                                تومان
                            </h4>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($weekorder as $order)
                                    <tr>
                                        <td>{{$order->id}}</td>
                                        <td>{{\App\User::query()->find($order->id_user)->firstname}}
                                            .{{(new \App\PublicModel())->short_string(\App\User::query()->find($order->id_user)->lastname)}}</td>
                                        <td>{{$order->price}}</td>
                    ...
                    <script>
                        ...
                        function ajax_id(id) {
                            ...
                            $(document).ready(function () {
                                ...
                                $.get("{{url('')}}product/ajax/" + id, function (data, status) {
                        ...
                        function ajax_name(name) {
                            ...
                            $(document).ready(function () {
                                document.getElementById('loading').style.display = 'block';
                                $.get("{{url('')}}product/ajax/name/" + name, function (data, status) {
            ...
            if (Object.keys(cols[col]).length != 0) {   //  col is Exists
                ...
                for (let row = 0; row < Object.keys(cols[col]).length; row++) {
                    appendRows +=
                        ...
                        '                        class="btn btn-default btn-number" data-url="{{url('admin/page/delete/')}}"\n' +
                        ...
                        '                        data-field="quant[1]" data-inputColNew="idColRow' + (col + 1) + (row + 1) + '" data-inputRowNew="idRowCol' + (col + 1) + (row + 1) + '" data-url="{{url('admin/page/update')}}">\n' +
