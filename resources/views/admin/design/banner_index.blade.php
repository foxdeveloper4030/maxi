            ...
            <div class="col-md-10">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">بنر شمار - {{$banner->id}} </h3>
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <img class="image" style="max-width: 300px" src="{{url('')}}/{{$banner->url}}">
                        <br>
                        <br>
                        <form enctype="multipart/form-data" method="post" action="{{route('admin.banner.edite',['id'=>$banner->id])}}">
                            <label>عنوان</label>
