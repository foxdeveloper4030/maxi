...
<head>
    ...
    <title>{{$slider->title}} | کنترل پنل</title>
                            ...
                            <form role="form" action="{{route('admin.slider.edite',['id'=>$slider->id])}}" method="post" enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input required="required" value="{{$slider->title}}" name="title" type="text" class="form-control" id="exampleInputEmail1" placeholder="عنوان">
                                    </div>
