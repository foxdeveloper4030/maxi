        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                       <label>ایجاد شده توسط:</label>
                        <a href="{{route('admin.users.showuser',['id'=>$ticket->user->id])}}">{{$ticket->user->firstname}} {{$ticket->user->lastname}}</a>                    </div>
                       <br>
                      <label>فایل</label>
                    @if($ticket->file!=null)
                        <td>
                ...
                @endif
                    ...
                    <br>
                    <form role="form" action="{{route('admin.tickets.replay',['id'=>$ticket->id])}}" method="post" enctype="multipart/form-data">
                        <div class="box-body">
