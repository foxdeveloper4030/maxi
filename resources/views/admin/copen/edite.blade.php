...
<head>
    ...
    <title>کپن {{$copen->code}}| کنترل پنل</title>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="{{route('admin.copen.update',['id'=>$copen->id])}}" method="post">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input value="{{$copen->code}}" id="observer" name="time" />
                                    <br>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body no-padding">
                            ...
                            <tr>
                                        ...
                                        <td>
                                            <a class="btn-danger btn" href="{{route('admin.copen.delete',['id'=>$copen->id])}}">
                                                حذف
                                            </a>
                                        </td>
                                    </tr>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="{{$copen->price}}" name="price" type="text" class="form-control"  id="product">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="{{$copen->off}}" id="cost" type="text" class="form-control"  name="off">
                                </div>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="{{$copen->code}}" type="text" class="form-control" name="code">
                                </div>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
