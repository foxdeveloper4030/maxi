            ...
            <div class="box">
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        @foreach(\App\Cariar::all() as $cariar)
                        <tr>
                            <td>{{$cariar->name}}</td>
                            <td>
                                @foreach($cariar->cyties as $city)
                                    {{\App\Province::query()->find($city->province_id)->name}}-

                                @endforeach
                            </td>
                            <td><a href="{{route('admin.cariar.show',['id'=>$cariar->id])}}" class="btn btn-primary">مشاهده</a></td>
                            <td>
                                @if($cariar->active==1)
