...
@section('title')
    بروزرسانی نقش {{$role->role}} | پنل ادمین
@endsection
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">بروزرسانی نقش {{$role->role}}</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{count($role->permissions)}}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-10">
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">بروزرسانی نقش {{$role->role}}</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" method="post"
                                  ...
                                  data-url="{{route('admin.roles.permission.update',$role->id)}}">
                                @csrf
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="permission" multiple
                                            ...
                                            @foreach($permissions as $permission)
                                                <option value="{{$permission->id}}">{{$permission->permission}}
                                                    / {{$permission->label}}
                                                </option>
                                            @endforeach
                                        </select>
