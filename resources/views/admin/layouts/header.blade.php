<header class="main-header">
    ...
    <a class="logo">
        ...
        <span><a class="button2" href="{{url('')}}" target="_blink">مشاهده سایت</a></span>
        <style>
    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
            ...
            {{--                        <span--}}
            {{--                            class="label label-success">{{count(\Illuminate\Support\Facades\DB::select('SELECT * FROM `usermessages` WHERE `read`=0'))}}</span>--}}
            {{--                    </a>--}}
            {{--                    <ul class="dropdown-menu">--}}
            {{--                        <li class="header">{{count(\Illuminate\Support\Facades\DB::select('SELECT * FROM `usermessages` WHERE `read`=0'))}}--}}
            {{--                            پیام خوانده نشده--}}
            {{--                        </li>--}}
            {{--                        <li>--}}
            {{--                            <!-- inner menu: contains the actual data -->--}}
            {{--                            <ul class="menu">--}}
            {{--                                @forelse(\App\UserMessage::query()->where('read','=',0)->limit(5)->get() as $message)--}}
            {{--                                    <li>--}}
            {{--                                        <!-- start message -->--}}
            {{--                                        <a href="#">--}}
            ...
            {{--                                            </h4>--}}
            {{--                                            <p>{{(new \App\PublicModel())->short_string($message['message'],40)}}</p>--}}
            {{--                                        </a>--}}
            {{--                                    </li>--}}
            {{--                            @empty--}}
            ...
            {{--                            </ul>--}}
            {{--                        </li>--}}
            {{--                        <li class="footer"><a href="{{route('admin.message.index'),$product}}">نمایش تمام پیام ها</a></li>--}}
            {{--                    </ul>--}}
            {{--                </li>--}}
            <!-- Notifications: style can be found in dropdown.less -->
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">{{$user4030->fullname}}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            ...
                            <span
                                style="display: block"><small>{{(new \App\Model\Date())->jdate('j/F/Y، ساعت H:i:s',$user4030->last_seen)}}</small></span>
                            <br>

                            <span> <a class="button" href="{{route('logout')}}" title="خروج"></a></span>
                            <span><a class="button1" href="{{url('')}}/user/panel/changepass">تغیر پسورد</a></span>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li class="header"><h4><a href="{{route('admin.home')}}">داشبورد</a></h4></li>
            <li class="header">منو</li>
            <li class=" treeview {{Route::currentRouteName()=='admin.home'?'active':''}}">
                <a href="">
                ...
                <ul class="treeview-menu">
                    <li class="{{Route::currentRouteName()=='admin.home'?'active':''}}"><a href="{{route('admin.order.index')}}"><i class="fa fa-list"></i> سفارش ها</a>
                    </li>
                    <li class="{{Route::currentRouteName()=='admin.home'?'active':''}}"><a href="{{route('admin.order.indexUnfinish')}}"><i class="fa fa-shopping-cart"></i>سبدهای
                            خرید ناتمام</a>
                </ul>
            </li>
            @can('user')
                ...
                <i class="fa fa-angle-right pull-left"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="nav-item {{Route::currentRouteName()=='admin.home'?'active':''}}"><a href="{{route('admin.users.show')}}" class="nav-link"><i class="fa fa-list"></i> لیست کاربران
                            </a>
                        </li>
                    </ul>
                </li>
                {{--                <li><a href="{{route('admin.users.show')}}"><i class="fa fa-user"></i> مدیریت کاربران</a></li>--}}
            @endcan
            @can('role')
                <li class="treeview">
                    <a href="">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('roles.index')}}"><i class="fa fa-rouble"></i>نقش‌ها</a>
                        </li>
                        <li><a href="{{route('admin.roles.permission.create')}}"><i class="fa fa-plus-circle"></i>افزودن
                                مسئولیت به نقش‌ها</a>
                        </li>
                        <li><a href="{{route('LevelManages.index')}}"><i class="fa fa-user-circle"></i>کاربران</a>
                        </li>
                        <li><a href="{{route('admin.user.roles.create')}}"><i class="fa fa-user-plus"></i>افزودن نقش به
                                کاربران</a>
                        </li>
                    </ul>
                </li>
            ...
            <li class="treeview {{Route::currentRouteName()=='admin.home'?'active':''}}">
                ...
                <ul class="treeview-menu">
                    @can('add-edit-product')
                        <li>
                            <a href="{{route('admincategory.create')}}"><i class="fa fa-plus-circle"></i> افزودن
                                دسته</a>
                        </li>
                    @endcan
                    @can('show-product')
                            ...
                            @else
                                <li class="treeview">
                                    <a style="cursor: pointer"><i class="fa fa-circle-o"></i><span
                                            ...
                                            class="badge"
                                            onclick="redirect1('{{route('admincategory.show',['id'=>$category->id])}}')"> {{$category->name}}
                                            </span>
                                    ...
                                    @include('admin.layouts.categorychilds',['category'=>$category])
                                </li>
                            @endif
                        @endforeach
                    @endcan
            ...
            <li class="treeview {{Route::currentRouteName()=='admin.home'?'active':''}}">
                ...
                <ul class="treeview-menu">
                    ...
                    @endcan
                    @can('show-product')
                        <li><a href="{{route('products.index')}}"><i class="fa fa-circle-o"></i> مشاهده همه محصولات</a>
                        </li>
                    @endcan
                        <li><a href="{{route('admin.color.index')}}"><i class="fa fa-circle-o"></i>  رنگ محصولات</a></li>
                        <li><a href="{{route('admin.warranty.index')}}"><i class="fa fa-circle-o"></i>گارانتی محصولات</a></li>
                </ul>
            </li>
            ...
            <li class="treeview {{Route::currentRouteName()=='admin.home'?'active':''}}">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('special.index')}}"><i class="fa fa-circle-o"></i> پیشنهاد شگفت انگیز</a></li>
                    <li><a href="{{route('special.create')}}"><i class="fa fa-circle-o"></i> افزودن پیشنهاد شگفت
                            انگیز</a></li>
                    <li><a href="{{route('admin.copen.create')}}"><i class="fa fa-circle-o"></i> افزودن کپن تخفیف</a>
                    </li>
                    <li><a href="{{route('admin.copen.show')}}"><i class="fa fa-circle-o"></i> کپن تخفیف</a></li>
            ...
            <li class="treeview {{Route::currentRouteName()=='admin'?'active':''}}">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('admin.banner.index')}}"><i class="fa fa-circle-o"></i> بنرها </a></li>
                    <li class="treeview">
                        <a href="">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('admin.slider.create')}}"><i class="fa fa-circle-o"></i> افزودن اسلایدر
                                </a></li>
                            <li><a href="{{route('admin.slider.index')}}"><i class="fa fa-circle-o"></i> همه اسلایدر ها</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li class="treeview {{Route::currentRouteName()=='admin.home'?'menu-open':''}}">
                <a href="">
                ...
                <ul class="treeview-menu">
                    <li class="{{Route::currentRouteName()=='admin'?'active':''}}"><a href="{{route('admin.page.index')}}" ><i class="fa fa-circle-o"></i>لیست صفحات</a></li>
                    <li><a href="{{route('admin.page.create')}}"><i class="fa fa-plus-circle"></i>ایجاد صفحات</a></li>
                    <li><a href="" data-toggle="modal" data-target="#editModal2" class="get-all-col-row"
                           data-url="{{route('admin.page.getAllColRow')}}">
            ...
            <li class="treeview {{Route::currentRouteName()=='admin.home'?'active':''}}">
                ...
                <ul class="treeview-menu">
                    <li class="{{Route::currentRouteName()=='admin.home'?'active':''}}"><a href="{{route('admin.brand.index')}}"><i class="fa fa-circle-o"></i>لیست برندها</a></li>
                    <li class="{{Route::currentRouteName()=='admin.home'?'active':''}}"><a href="{{route('admin.brand.create')}}"><i class="fa fa-plus-circle"></i>ایجاد برند</a></li>
                </ul>
            </li>
            <li class="treeview {{Route::currentRouteName()=='admin.home'?'active':''}}">
                <a href="">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('admin.cariar.index')}}"><i class="fa fa-circle-o"></i>روش های ارسال</a></li>
                    <li><a href="{{route('admin.cariar.create')}}"><i class="fa fa-plus-o"></i>افزودن</a></li>
                </ul>
            </li>
            <li><a href="{{route('admin.tickets')}}"><i class="fa fa-ticket"></i> <span>تیکت ها</span></a></li>
