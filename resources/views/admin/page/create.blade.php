            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{count(\App\Page::all())}}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-account-row" style="margin-top: 4%">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-account-row">
                                                            ...
                                                            <img style="width: 550px;height: auto;position:relative;
                                                                 ...
                                                                 src="{{asset('public/assets/img/about_bg.jpg')}}"
                                                                 alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="product-variants default"
                                            ...
                                            <div id="addRow" data-url="{{url('admin/page/addRowInPage')}}"
...
@section('js')
    ...
    {{--    <script src="bower_components/ckeditor_4.13.1_standard/ckeditor/ckeditor.js"></script>--}}
    <script>
        ...
        $(function () {
            ...
            CKEDITOR.replace('body', {
                language: 'fa',
                filebrowserUploadUrl: '{{route('admin.page.imageUpload')}}',
                filebrowserImageUploadUrl: '{{route('admin.page.imageUpload')}}',
                ...
                {{--                filebrowserUploadUrl: '{{route("admin.page.store",["_token"=>csrf_token()])}}',--}}
                // filebrowserUploadMethod: 'form'
