...
@section('title')
    بروزرسانی نقش کاربر{{$user->fullName}} | پنل ادمین
@endsection
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">بروزرسانی نقش {{$user->role}}</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">تعداد نقش‌های کاربر {{$user->fullName}}</span>
            ...
            <div class="col-md-10">
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">بروزرسانی نقش کاربر {{$user->fullName}}</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" method="post"
                                  ...
                                  data-url="{{route('admin.user.roles.update',$user->id)}}">
                                @csrf
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <script type="text/javascript">
                                            roleIdSelected[idx] = "{{$user->roles()->first()->id}}";
                                            idx++;
                                        </script>
                                    </div>
                                </div>
