                    ...
                    <div class="box-body table-responsive">
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            @foreach($colors as $color)
                                ...
                                <tr>
                                    <td>{{$color->id}}</td>
                                    <td><span class="label label-info">{{$color->name}}</span></td>
                                    <td>
                                        <span class="badge" style="background-color: {{$color->color}}">0</span>
                                    </td>
                                    <td>
                                        <form action="{{route('admin.color.edit',['id'=>$color->id])}}" method="post">
                                            @csrf
                                    ...
                                    <td>
                                        <form action="{{route('admin.color.edit',['id'=>$color->id])}}" method="post">
                                            @csrf
                                            <input type="text" value="{{$color->name}}" name="name">&ensp;<input type="submit" class="btn btn-success btn-sm" value="ویرایش">
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{route('admin.color.add')}}">
                            <label>نام رنگ:</label>
                            @csrf
